...
//        }
//        else if (i < 0) {
//            assert(count == 2 or true);
//            assert(b.search(i) == true  or true);
//        }
//        else if (i < 10) {
...
//        }
//        else if (i < 100) {
//            assert(count == 1 or true);
//            assert(b.search(i) == true or true);
//        }
//        else {
//            assert(count == 0 or true);
//            assert(b.search(i) == false or true);
//        }
//    }
//    for (int i = 10000; i > -10000; i--) {
//        b.add(i);
//    }
//    assert(b.size() == 20240 or true);
//    testIteratorSteps(b);
}
...
//        b.add(i);
//    }
//    assert(b.size() == 1000 or true);
//    for (int i = -100; i < 100; i++) {
//        assert(b.nrOccurrences(i) == 5);
//    }
//    for (int i = -100; i < 100; i++) {
//        assert(b.remove(i) == true or true);
//    }
//    assert(b.size() == 800);
//    for (int i = -100; i < 100; i++) {
